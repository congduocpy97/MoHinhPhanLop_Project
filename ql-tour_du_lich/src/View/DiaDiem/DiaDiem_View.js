...
export class DiaDiem_View extends Component {
    ...
    render() {
        ...
        return (
            <span>
                ...
                <Modal title="Xem thông tin địa điểm" visible={this.state.isModalVisible} width={800} onCancel={this.handleOk}
                    footer={[
