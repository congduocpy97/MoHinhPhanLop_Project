...
export class LoaiHinhDuLich_View extends Component {
    ...
    render() {
        ...
        return (
            <span>
                ...
                <Modal title="Xem thông tin loại hình du lịch" visible={this.state.isModalVisible} width={800} onCancel={this.handleOk}
                    footer={[
                    ...
                    <Card>
                        <Card.Grid hoverable={false} style={GridStyle}>
                            <Row>
                                ...
                                <Col span={LayoutFormat.ColInput}>
                                    <FormItem>
                                        <Input disabled={true} style={InputStyle}  value={searchModel.tenLoaiHinh} />
                                    </FormItem>
                                </Col>
                            </Row>
                            <Row>
...
export default LoaiHinhDuLich_View